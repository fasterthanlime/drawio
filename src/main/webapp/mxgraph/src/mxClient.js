...
var mxClient = {
   ...
   */
  IS_WEBVIEW: /((iPhone|iPod|iPad).*AppleWebKit(?!.*Version)|; wv)/i.test(
    navigator.userAgent,
  ),
...
if (
  ...
  mxClient.include(
    mxClient.basePath + "/layout/hierarchical/model/mxGraphHierarchyNode.js",
  );
  mxClient.include(
    mxClient.basePath + "/layout/hierarchical/model/mxGraphHierarchyEdge.js",
  );
  mxClient.include(
    mxClient.basePath + "/layout/hierarchical/model/mxGraphHierarchyModel.js",
  );
  mxClient.include(
    mxClient.basePath + "/layout/hierarchical/model/mxSwimlaneModel.js",
  );
  mxClient.include(
    mxClient.basePath +
  ...
  mxClient.include(
    mxClient.basePath + "/layout/hierarchical/stage/mxMinimumCycleRemover.js",
  );
  mxClient.include(
    mxClient.basePath + "/layout/hierarchical/stage/mxCoordinateAssignment.js",
  );
  mxClient.include(
    mxClient.basePath + "/layout/hierarchical/stage/mxSwimlaneOrdering.js",
  );
  mxClient.include(
    mxClient.basePath + "/layout/hierarchical/mxHierarchicalLayout.js",
  );
  mxClient.include(
    mxClient.basePath + "/layout/hierarchical/mxSwimlaneLayout.js",
  );
